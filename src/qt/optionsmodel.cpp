...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeDroidzAmount"))
        settings.setValue("nAnonymizeDroidzAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizeDroidzAmount = settings.value("nAnonymizeDroidzAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizeDroidzAmount"))
        SoftSetArg("-anonymizedroidzamount", settings.value("nAnonymizeDroidzAmount").toString().toStdString());
}
